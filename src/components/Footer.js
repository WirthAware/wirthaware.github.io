...
const background = "palevioletred";
const Icon = styled.svg`
  ...
  &:hover {
    ...
    fill: ${background};
    transform: scale(1.5);
    transition: background-color 2.5s, transform .2s ease-out;
  }
`;
...
const FooterWrapper = () => (
  <Footer>
    <IconList>
      <IconListItem>
        {/* mail */}
        <a href="mailto:stephan.wirth@mail.de">
          <Icon>
      ...
      {/* github */}
      <IconListItem>
        <a href="http://www.github.com/wirthaware">
          <Icon>
      ...
      {/* twitter */}
      <IconListItem>
        <a href="http://www.twitter.com/wirthaware">
          <Icon>
